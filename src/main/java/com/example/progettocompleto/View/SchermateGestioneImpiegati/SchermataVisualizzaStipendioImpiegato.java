...
public class SchermataVisualizzaStipendioImpiegato{
    @FXML
    ...
    public SchermataVisualizzaStipendioImpiegato(ControlGestioneImpiegati controlGestioneImpiegati, Stipendio stipendio){
    ...
    public void initialize(){
        ...
        meseBox.setOnAction(event->{
            mostraValori(controlGestioneImpiegati.getResocontoStipendio(stipendio.getImpiegato(),meseBox.getValue(),annoBox.getValue()));
