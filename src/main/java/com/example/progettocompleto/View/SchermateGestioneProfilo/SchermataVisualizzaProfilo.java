...
controlVisualizzaProfilo.clickModificaPassword();
   ...
   public void clickIndietro(ActionEvent e){
        ...
        public static void show(List<Object> datiProfiloAggiornati){
            Util.setScene("/com/example/progettocompleto/FXML/GestioneProfilo/SchermataVisualizzaProfilo.fxml", Start.mainStage, c->new SchermataVisualizzaProfilo(new ControlVisualizzaProfilo(),(ArrayList<Object>) datiProfiloAggiornati));
        }
    public static void show(List<Object> datiProfiloAggiornati, InputStream pa){
        Util.setScene("/com/example/progettocompleto/FXML/GestioneProfilo/SchermataVisualizzaProfilo.fxml", Start.mainStage, c->new SchermataVisualizzaProfilo(new ControlVisualizzaProfilo(),(ArrayList<Object>) datiProfiloAggiornati));
    }
    }
