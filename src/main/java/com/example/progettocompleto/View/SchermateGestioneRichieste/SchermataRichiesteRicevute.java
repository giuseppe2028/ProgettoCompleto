...
import com.example.progettocompleto.Controller.ControlGestioneRichieste.ControlRichiesteRicevute;
...
public class SchermataRichiesteRicevute {
    ...
    @FXML
    private TableColumn<Richiesta, Integer> matrOCol;
    @FXML
    ...
    public void loadDate() throws SQLException {
        ...
        matrOCol.setCellValueFactory(new PropertyValueFactory<>("id"));
    ...
    public static void show(ControlRichiesteRicevute controlRichiesteRicevute){
        Util.setScene("/com/example/progettocompleto/FXML/GestioneRichieste/SchermataGestioneRichieste.fxml", Start.mainStage, c->new SchermataRichiesteRicevute(controlRichiesteRicevute));
    }
}
