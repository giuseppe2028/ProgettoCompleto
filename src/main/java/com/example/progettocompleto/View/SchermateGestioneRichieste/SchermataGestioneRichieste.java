...
public static void show(ControlGestioneRichieste controlGestioneRichieste,List<Richiesta> richieste){
    Util.setScene("/com/example/progettocompleto/FXML/GestioneRichieste/SchermataGestioneRichieste.fxml", Start.mainStage, c->new SchermataGestioneRichieste(controlGestioneRichieste,richieste));
}
