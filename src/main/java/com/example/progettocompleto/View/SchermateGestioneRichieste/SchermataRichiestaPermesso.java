...
public static void show(){
        Util.setScene("/com/example/progettocompleto/FXML/GestioneRichieste/SchermataRichiestaPermesso.fxml", Start.mainStage, c->new SchermataRichiestaPermesso(new ControlGestioneRichieste()));
}
