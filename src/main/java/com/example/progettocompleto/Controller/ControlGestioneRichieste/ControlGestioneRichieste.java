...
import com.example.progettocompleto.View.SchermateGestioneRichieste.*;
...
public class ControlGestioneRichieste {
    ...
    public ControlGestioneRichieste() {
        Util.setSpecificScene("/com/example/progettocompleto/FXML/GestioneRichieste/SchermataGestioneRichieste.fxml", stage, c -> new SchermataGestioneRichieste(this,Daemon.getRichieste(EntityUtente.getMatricola())));
    }
    public void clickCongedoLutto() {
        Util.setScene("/com/example/progettocompleto/FXML/GestioneRichieste/SchermataCongedoLutto.fxml", stage, c -> new SchermataCongedoLutto(this));
    }

    public void clickRichiestaPermesso() {
        Util.setScene("/com/example/progettocompleto/FXML/GestioneRichieste/SchermataRichiestaPermesso.fxml", stage, c -> new SchermataRichiestaPermesso(this));
    }

    public void clickElimina(int id) throws SQLException {
        Daemon.delete(id);
        Util.setScenePopup("/com/example/progettocompleto/View/Popup/PopupInformazione.fxml",stagePopup,c-> new PopupInformazione("Richiesta eliminata correttamente",stagePopup));
    ...
    public void clickRichiestaFerie() {
        ...
        Util.setSpecificScene("/com/example/progettocompleto/FXML/GestioneRichieste/SchermataRichiestaFerie.fxml", stage, c -> new SchermataRichiestaFerie(this, dateI, dateF));
    }
    ...
    public void clickRichiestaSciopero() {
        Util.setScene("/com/example/progettocompleto/FXML/GestioneRichieste/SchermataRichiestaSciopero.fxml", stage, c -> new SchermataRichiestaSciopero(this));
    }
    ...
    public void clickCongedoParentale(){
        Util.setScene("/com/example/progettocompleto/FXML/GestioneRichieste/SchermataCongedoParentale.fxml", stage, c-> new SchermataCongedoParentale(this));
    }
    ...
    public void clickRichiestaMaternita() {
        Util.setScene("/com/example/progettocompleto/FXML/GestioneRichieste/SchermataRichiestaMaternita.fxml", stage, c -> new SchermataRichiestaMaternita(this));
    }
...
Daemon.insertMaternita(matricola, dataInizio, dataFine, file);
    ...
    public void clickRichiestaMalattia() {
        Util.setScene("/com/example/progettocompleto/FXML/GestioneRichieste/SchermataRichiestaMalattia.fxml", stage, c -> new SchermataRichiestaMalattia(this));
       }
...
public void clickRichiestaCambio(){
        ...
        Util.setScene("/com/example/progettocompleto/FXML/GestioneRichieste/SchermataRichiestaCambioTurno.fxml", stage, c-> new SchermataRichiestaCambioTurno(this, turni, matricola));
}
